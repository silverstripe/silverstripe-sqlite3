...
class SQLite3SQLTranspilerTest extends TestCase
{
     ...
     */
    protected function enableMySQLCompat()
    {
...
ORDER BY CASE ManyManyEagerLoadObjectID WHEN 1 THEN 0 WHEN 2 THEN 1 WHEN 5 THEN 2 WHEN 6 THEN 3 ELSE 4 END',
     ...
     */
    public function testStraightJoinNotConvertedWhenDisabled()
    {
     ...
     */
    public function testStraightJoinRewrite()
    {
     ...
     */
    public function testStraightJoinCaseInsensitive()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testOnDuplicateKeyUpdateNotRewrittenWhenDisabled()
    {
     ...
     */
    public function testOnDuplicateKeyUpdateRewrite()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testOnDuplicateKeyUpdateCaseInsensitive()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testNowFunctionNotRewrittenWhenDisabled()
    {
     ...
     */
    public function testNowFunctionRewrite()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testNowFunctionCaseInsensitive()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testUnixTimestampNotRewrittenWhenDisabled()
    {
     ...
     */
    public function testUnixTimestampNoArgsRewrite()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testUnixTimestampWithArgRewrite()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testUnixTimestampCaseInsensitive()
    {
        $this->enableMySQLCompat();
    ...
    /**
     * Test that non-matching queries don't trigger transpilation for new methods
     */
    public function testNonMatchingQueriesNotTranspiled()
    {
        $sql = 'SELECT * FROM "Test" WHERE "Name" = \'JOIN\'';
        $result = $this->transpiler->transpile($sql);

        // Should remain unchanged - JOIN is in a string literal
        $this->assertEquals($sql, $result);
        $this->assertFalse($this->transpiler->didTranspile());
    }
     ...
     */
    public function testNowFunctionInStringLiteralNotTransformed()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testUnixTimestampInStringLiteralNotTransformed()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testStraightJoinInStringLiteralNotTransformed()
    {
        $this->enableMySQLCompat();
     ...
     */
    public function testEscapedQuotesInStringLiterals()
    {
